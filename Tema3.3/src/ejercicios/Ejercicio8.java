...
public class Ejercicio8 {
	...
	public static void main(String[] args) {
		//Creamos un HashMap que tendra una clave cadena con un par valor entero que actuaran como un usuario y su contraseña
		HashMap<String, Integer> listaContraseñas = new HashMap<>();
		//Creamos una variable entera contraseña que recibira la contraseña que se escriba en consola por el usuario
		int contraseña;
		//Variable entera que comprobara los intentos que le quedan disponibles al usuario para introducir los datos correctamente
		int intentos = 3;
		//Variable tipo cadena que recibira el usuario escrito por consola
		String usuario;
		//Variable tipo entera que recibira por consola la accion que quiere realiar el usuario
		int eleccion;
		//Variable booleana que servira para detectar si el usuario quiere salir del programa o se ha quedado sin intentos
		boolean salir = false;
		...
		while (salir == false) {
			...
			//Si el usuario elige la opcion 2
				...
				if (contraseña == listaContraseñas.get(usuario) && intentos > 0) {
